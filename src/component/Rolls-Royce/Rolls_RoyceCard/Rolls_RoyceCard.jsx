...
const Rolls_RoyceCard = ({data,HandleDelete}) => {
     ...
     <div className="card lg:card-side bg-yellow-100 shadow-xl">
       ...
       <div className="card-body">
         ...
         <Link to={`/Rolls_Royce/${_id}`}>
            ...
            <Link to={`/update5/${_id}`}><button className="btn btn-secondary">Update</button></Link>
         </div>
       </div>
     </div>
   </div>
...
export default Rolls_RoyceCard;