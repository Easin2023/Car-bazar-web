      ...
      <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
        ...
        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            ...
            <div className="mt-12 space-y-12">
              <div className="flex">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-md bg-rose-400 ">
                    <svg
          ...
          <div aria-hidden="true" className="mt-10 lg:mt-0">
            <img
              src="https://cf-images.eu-west-1.prod.boltdns.net/v1/static/1634657725001/ba09b9c0-3ac9-4142-a1b5-9dfc6a253675/d2d540f1-e721-4080-95ba-df36970ccf3e/1080x1920/match/image.jpg"
              alt=""
        ...
        <div>
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            ...
            <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
              <img
                src="https://www.motortrend.com/uploads/2023/05/2-2023-Rolls-Royce-Black-Badge-Cullinan-Blue-Shadow-front-view.jpg?fit=around%7C875:492.1875"
                alt=""
