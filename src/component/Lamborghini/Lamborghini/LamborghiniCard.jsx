...
const LamborghiniCard = ({ data,HandleDelete }) => {
     ...
     <div className="card lg:card-side bg-yellow-100 shadow-xl">
       ...
       <div className="card-body">
         ...
         <Link to={`/Lamborghini/${_id}`}>
            ...
            <Link to={`/update2/${_id}`}><button className="btn btn-secondary">Update</button></Link>
         </div>
       </div>
     </div>
   </div>
...
export default LamborghiniCard;
